            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <Link 
                    href="/courses"
                    className="bg-[#FF7A7A] hover:bg-[#ff5e5e] border-2 border-black text-white px-6 py-3 rounded-full text-center text-sm font-bold transition-all shadow-lg hover:shadow-xl"
                  >
                    Find a Course
                  </Link>
                  <Link 
                    href="/emergency-contacts"
                    className="bg-white hover:bg-gray-50 border-2 border-black text-gray-700 px-6 py-3 rounded-full text-center text-sm font-bold transition-all shadow-lg hover:shadow-xl"
                  >
                    Emergency Contacts
                  </Link>
                </div>
