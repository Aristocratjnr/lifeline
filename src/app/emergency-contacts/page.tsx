...
const EmergencyContactsPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <NavBar />
      <main className="flex-grow py-8 sm:py-12 px-3 sm:px-4 lg:px-8">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl border border-black shadow-sm p-4 sm:p-6 md:p-8">
        ...
        <div className="mb-10 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Emergency Numbers by Country</h2>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="px-3 py-2 sm:px-4 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                      Notes
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200 text-sm">
                  {emergencyContacts.map((contact, index) => (
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      <td className="px-3 py-3 whitespace-nowrap font-medium text-gray-900 text-sm sm:text-base">
                        {contact.country}
                      </td>
                      ...
                      <td className="px-3 py-3 text-gray-500 text-xs sm:text-sm hidden sm:table-cell">
                        {contact.notes}
                      </td>
                    </tr>
                  ))}
        ...
        <div className="mt-10 sm:mt-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Additional Important Numbers</h2>
          <div className="grid gap-4 sm:gap-5 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {importantNumbers.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4 sm:p-5 hover:shadow-md transition-shadow">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{item.name}</h3>
                <p className="mt-2 text-xl sm:text-2xl font-bold text-[#FF7A7A] break-words">{item.number}</p>
        ...
        <div className="mt-10 sm:mt-12 bg-blue-50 p-3 sm:p-4 rounded-lg">
          <div className="flex">
